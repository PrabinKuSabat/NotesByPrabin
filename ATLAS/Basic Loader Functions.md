...
In the SIC implementation, the bootstrap loader often reads from device 'F1'. It must be written with extreme care to be as small as possible, as it often fits into a very limited amount of ROM or a specific hardware buffer. This section highlights the "hardware/software boundary" that every systems engineer must master to understand how a machine transitions from a hunk of silicon to a functional computing environment.
