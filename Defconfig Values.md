...
CONFIG_DEFAULT_DEVICE_TREE="x1_spl"
...
CONFIG_SYS_MMCSD_RAW_MODE_U_BOOT_SECTOR=0x680
...
CONFIG_MTDPARTS_DEFAULT="d420c000.spi-0:64K@0(bootinfo)K@64K(private)K@128K(fsbl)K@384K(env)K@448K(opensbi),-@640K(uboot)"
...
CONFIG_KY_X1_EFUSE=y

CONFIG_SPL_KY_X1_EFUSE=y

CONFIG_KY_SHUTDOWN_CHARGE=y
...
CONFIG_SPL_KY_POWER=y

CONFIG_DM_PWM=y

CONFIG_PWM_PXA=y

CONFIG_RESET_KY_X1=y
...
CONFIG_DISPLAY_KY_HDMI=y

CONFIG_DISPLAY_KY_MIPI=y

CONFIG_DISPLAY_KY_EDP=y

CONFIG_WDT_KY=y

CONFIG_WDT_PMIC_KY=y
